            ...
            <form onSubmit={handleSubmit} action="#" className="space-y-6">
                ...
                <div className="space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
                    ...
                    <input
                        ...
                        ref={CaptchaRef}
                    />
                    <button t onClick={handleValidateCaptcha} className="btn btn-outline w-full  btn-xs">VALIDATE</button>
                </div>

               <div className=''>
                <input disabled={disabled} className='btn w-full btn-primary' type="submit"  />
               </div>
            </form>
